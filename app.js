const wordList = [["아보카도", "망치", "망고",  "반지", "여우", "앵무새", "교수", "대학생", "고양이", "연필", "오징어", "딸기", "스타벅스", "KFC", "콜라", "사이다", "노트북", "떡볶이", "김밥", "아령", "컴퓨터", "핫도그", "뉴발란스", "인공눈물", "맥도날드", "나루토", "유튜브", "미용실", "근손실", "치킨", "소", "에어팟", "한국외대", "스파게티","만두","아이스크림", "웰시코기", "틀니", "입생로랑", "팬더", "버블티", "닌텐도스위치", "피자", "손목시계","병아리", "당근", "소맥", "생일", "사과","환자", "문신", "초밥", "피카츄", "게", "롯데리아", "사랑의 불시착", "고래", "개구리", "태극기", "그루트", "얼룩말", "삽살개", "딱따구리", "토끼", "전동킥보드", "소화기"],
